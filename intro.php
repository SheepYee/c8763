...

{
    ...
    $del = $_POST['proid'];
    $sql="DELETE FROM `intro` WHERE `intro_id` = '".$del."'";
    $aa = filterTable($sql);
    
    $sq="DELETE FROM `intro_img` WHERE `intro_id` = '".$del."'";
    $bb = filterTable($sq);
...

{
 ...
 header("location:../justshing/edit_intro.php");
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="container">
        <div class="row" style="margin: 2% 0 2% 0;">
            ...
            <div class="col-md-2">
                <a href="new_intro.php"><button type="button" class="btn btn-success" style="font-size: 22px;">新增簡介</button></a>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="intro.php">
                                    <input style="display:none" type="" name="proid" value="<?php echo $row['intro_id']; ?>">
