...
$sql = "SELECT * FROM `product` WHERE `product_id`='".$_SESSION['editpid']."'";
        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 heading">
                    <h1 class="page-header"><i class="im-plus"></i>編輯商品</h1>
                    <!-- Start .bredcrumb -->
                                    ...
                                    <form method="POST" action="main.php" enctype="multipart/form-data" class="form-horizontal group-border hover-stripped" role="form" id="validate">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">商品標題</label>
                                                <div class="col-lg-10">
                                                    <input name="product_title" type="text" class="form-control required" value=" <?php  echo $row['product_title']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <optgroup label="選擇商品類別"  >
                                                       
                                                        <?php $id =  $row['product_category'];?>
                                                <option value="1" <?php if($id == 1){echo "selected";}?>>最新商品</option>
                                                <option value="2" <?php if($id == 2){echo "selected";}?>>廣告裡贈品</option>
                                                <option value="3" <?php if($id == 3){echo "selected";}?>>產品包裝</option>
                                                <option value="4" <?php if($id == 4){echo "selected";}?>>文化書冊、型錄</option>
                                                <option value="5" <?php if($id == 5){echo "selected";}?>>複製微噴</option>
                                                <option value="6" <?php if($id == 6){echo "selected";}?>>RFID & NFC</option>
                                                    </optgroup>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea name="textarea" id="texteditor1" class="form-control tinymce-box"><?php  echo $row['product_detail']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-2">
                                                    <button name="edit_product" class="btn btn-default ml15" type="submit">更新完成</button>
                                                </div>
                                            </div>
                                            <?php endwhile;?>
                                            <!-- End .form-group  -->
