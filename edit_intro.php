...
$sql = "SELECT * FROM `intro` WHERE `intro_id`='".$_SESSION['editpid']."'";
        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 heading">
                    <h1 class="page-header"><i class="im-plus"></i>編輯簡介</h1>
                    <!-- Start .bredcrumb -->
                                    ...
                                    <form method="POST" action="main.php" enctype="multipart/form-data" class="form-horizontal group-border hover-stripped" role="form" id="validate">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">簡介標題</label>
                                                <div class="col-lg-10">
                                                    <input name="intro_title" type="text" class="form-control required" value=" <?php  echo $row['intro_title']; ?>">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">簡介詳細內容</label>
                                                <div class="col-lg-10">
                                                    <textarea name="textarea" id="texteditor1" class="form-control tinymce-box"><?php  echo $row['intro_detail']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <!-- End .form-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">上傳icon</label>
                                                <div class="col-lg-10">
                                                    <input name="iconfile" type="file" multiple="multiple" id="icon">
                                                </div>
                                            </div>
                                            <!-- End .form-group  -->
                                            <div class="form-group">
                                                <div class="col-lg-offset-2">
                                                    <button name="intro_edit" class="btn btn-default ml15" type="submit">更新完成</button>
                                                </div>
                                            </div>
                                            <?php endwhile;?>
                                            <!-- End .form-group  -->
