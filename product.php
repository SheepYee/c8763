...

{
    ...
    $sq="DELETE FROM `product_img` WHERE `product_id` = '".$del."'";
    $bb = filterTable($sq);
...

{
 ...
 header("location:../justshing/edit_product.php");
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <div class="container">
        <div class="row" style="margin: 2% 0 2% 0;">
            ...
            <div class="col-md-2">
                <a href="new_product.php"><button type="button" class="btn btn-success" style="font-size: 22px;">新增商品</button></a>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="product.php">
                                    <input style="display:none" type="" name="proid" value="<?php echo $row['product_id']; ?>">
