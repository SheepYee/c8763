                                ...
                                <div class="panel-body">
                                    <form method="POST" action="main.php" enctype="multipart/form-data" class="form-horizontal group-border hover-stripped" role="form" id="validate">
                                            ...
                                            <div class="col-lg-10">
                                                <select class="form-control select2" name="pro_category">
                                                    <optgroup label="選擇商品類別"  >
                                                        ...
                                                        <option value="2">廣告裡贈品</option>
                                                        <option value="3">產品包裝</option>
                                                        <option value="4">文化書冊、型錄</option>
                                                        <option value="5">複製微噴</option>
                                                        <option value="6">RFID & NFC</option>
                                                    </optgroup>
                                                    </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea name="product_detail" id="texteditor1" class="form-control tinymce-box"></textarea>
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2">
                                                <button name="product_up" class="btn btn-default ml15" type="submit">新增簡介</button>
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                    </form>
