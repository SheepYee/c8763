        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 heading">
                    <h1 class="page-header"><i class="im-plus"></i> 新增簡介</h1>
                    <!-- Start .bredcrumb -->
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="main.php" enctype="multipart/form-data" class="form-horizontal group-border hover-stripped" role="form" id="validate">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input name="intro_title" type="text" class="form-control required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea name="intro_detail" id="texteditor1" class="form-control tinymce-box"></textarea>
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input name="iconfile" type="file" id="icon">
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        <div class="form-group">
                                            <div class="col-lg-offset-2">
                                                <button name="intro_up" class="btn btn-default ml15" type="submit">新增簡介</button>
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                    </form>
