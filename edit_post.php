...
$sql = "SELECT * FROM `post` WHERE `post_id`='".$_SESSION['editpid']."'";
                                    ...
                                    <form method="POST" action="main.php" enctype="multipart/form-data" class="form-horizontal group-border hover-stripped" role="form" id="validate">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input name="p_name" type="text" class="form-control required" value=" <?php  echo $row['post_title']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea name="textarea" id="texteditor1" class="form-control tinymce-box"><?php  echo $row['post_detail']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-2">
                                                    <button name="editbtn" class="btn btn-default ml15" type="submit">更新完成</button>
                                                </div>
                                            </div>
                                            <?php endwhile;?>
                                            <!-- End .form-group  -->
