...

{
    ...
    $del = $_POST['proid'];
    $sql="DELETE FROM `printing_service` WHERE `printing_id` = '".$del."'";
    $aa = filterTable($sql);

    $sq="DELETE FROM `printing_service_img` WHERE `printing_id` = '".$del."'";
    $bb = filterTable($sq);
...

{
 ...
 header("location:../justshing/edit_printing_service.php");
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php echo $row['printing_uptime'];?>
                            </td>
                            <!-- 公告時間 -->

                            <td>

                                <form method="POST" action="printing_service.php">
                                    <input style="display:none" type="" name="proid" value="<?php echo $row[ 'printing_id']; ?>">
